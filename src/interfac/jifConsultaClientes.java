...
import report.GerarFichas;

/**
 * Consulta listagem de clientes com base no dado inserido, podendo capturar
 * dados para outra pagina
 *
 */
public class jifConsultaClientes extends javax.swing.JInternalFrame {
    ...
    private void initComponents() {
        ...
        jTabela.setModel(new javax.swing.table.DefaultTableModel(
            ...
            new String [] {
                "Cod.", "Razão Social", "Apelido", "I.E", "CNPJ/CPF", "Cidade", "Estado"
            }
        ) {
        ...
        jcTipo.setModel(new javax.swing.DefaultComboBoxModel<>(new String[] { "Cod.", "Razão Social", "Apelido", "Inscrição Estadual", "CNPJ/CPF", "Cidade", "Estado" }));
    ...
    private void jbCapActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jbCapActionPerformed
        ...
        if (jPrincipal.fichao == true) {
            ...
            jifCliente.recebeidClientes(objpes);
    ...
    private void formInternalFrameOpened(javax.swing.event.InternalFrameEvent evt) {//GEN-FIRST:event_formInternalFrameOpened
        ...
        try {
            ...
            while (rs.next()) {
                ...
                String Coluna5 = rs.getString("pes_cidadeF").trim();
                String Coluna6 = rs.getString("pes_ufF").trim();
    ...
    private void jbFichaActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jbFichaActionPerformed
        ...
        /*
        int row = jTabela.getSelectedRow();
        int col = jTabela.getSelectedColumn();
         */
        String tipo = "";
        String escolha = jcTipo.getSelectedItem().toString().trim();
        ...
        GerarFichas rel = new GerarFichas();

        try {
            rel.fichas("C:\\Users\\user\\Desktop\\NetBeansProjects\\Ficha Armagedon\\cliente.jasper", tipo, arg);
        } catch (Exception e) {
